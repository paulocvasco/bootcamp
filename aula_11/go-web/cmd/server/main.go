...
import (
	"bootcamp/aula_11/go-web/cmd/server/authentication"
	"bootcamp/aula_11/go-web/cmd/server/controller"
	"bootcamp/aula_11/go-web/internal/transactions/repository"
	"bootcamp/aula_11/go-web/internal/transactions/services"
...
func mapRouters(r *gin.Engine, c controller.Controller) {
	...
	tr.PUT("/:id", authentication.ValidateToken(), c.Update)
}
